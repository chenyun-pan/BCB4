...
bey.Sao = bey.Sadd + nadd*(2*bey.Sse+bey.Sxor+2*bey.Snan+bey.Smux+bey.Sic*fac_ao);

switch cop.name
    case {'BisFET','ITFET'}
        bey.Eao = bey.Eao+bey.tao*(2*bey.Sse+2*bey.Snan+bey.Sxor)*nadd;
end  
...
if cop.leak == 1 && cop.pipeline == 0 && ~strcmp(cop.name,'BisFET') && ~strcmp(cop.name,'ITFET')
    bey.Ealu = bey.Ealu+bey.Salu*bey.talu; 
end
end
