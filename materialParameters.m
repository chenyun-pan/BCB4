...
cop.F = 15e-9;                      % metal half-pitch, m
cop.Lch = 12.8e-9;                  % gate channel length
...
cop.Jg = 1e5;                       % gate leakage current density, A/m^2
...
cop.Cpiezo = eps0*cop.epspiezo/cop.thpiezo;     % capacitance of piezo
...
cop.thFM = 3e-9;                    % thickness of a ferromagnet, m
...
% inverse Rashba effect to generate current(M)
cop.Rrash = 4000;                   % wiring resistance in Rashba effect
cop.coefrash = 1;                 % inverse rashbaa translation coefficient
